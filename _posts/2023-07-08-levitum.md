...
header:
  ...
  teaser: /assets/images/posts/levitum/teaser.jpg
---
...
<p style="text-align:center;"><img src="{{ "/assets/images/posts/levitum/team_happy.jpg" | absolute_url }}" width="100%" hspace="5"></p>
...
I also did aerodynamics analysis with Python scripts like SUAVE and tools like AVL (Athena Vortex Lattice).
